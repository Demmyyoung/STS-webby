...
export interface ApiIdontKnowWhatImDoingIdontKnowWhatImDoing
  ...
  info: {
    displayName: 'idont know what im doing';
    pluralName: 'idont-know-what-im-doings';
    singularName: 'idont-know-what-im-doing';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::idont-know-what-im-doing.idont-know-what-im-doing'
    > &
      Schema.Attribute.Private;
    Product1: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
